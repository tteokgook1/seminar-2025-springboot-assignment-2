...
class PostIntegrationTest
    ...
    constructor(
        ...
        private fun assertPostsAreSame(
            ...
            targetPosts
                .zip(
                    originalPosts.sortedByDescending { it.createdAt },
                ).forEach { (targetPost, originalPost) ->
                    val board = boardRepository.findByIdOrNull(originalPost.boardId)!!
                    val user = userRepository.findByIdOrNull(originalPost.userId)!!
                    assertTrue(targetPost == PostDto(originalPost, user, board))
                }
        }
    }
